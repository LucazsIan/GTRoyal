document.addEventListener("DOMContentLoaded", () => {
  ...
  const privacyPolicySection = document.getElementById(
  ...
  const sendCommentsMessageButton = document.getElementById(
    "send-comments-message-button"
  );
  const commentsMessageInput = document.getElementById(
    "comments-message-input"
  );
  const sendHelpMessageButton = document.getElementById(
    "send-help-message-button"
  );
  ...
  optionButtons.forEach((button) => {
    if (
      ...
      button.id !== "ratings-button" &&
      button.id !== "privacy-policy-button" &&
      button.id !== "comments-button" &&
      button.id !== "notifications-button" &&
      button.id !== "terms-of-use-button" &&
